# ============================================================
#  Setup-Terminal-Main.ps1 — Automated terminal environment setup
#
#  This is the main setup script (requires PowerShell 7+).
#  Launch via Setup-Terminal.ps1 which handles PS5 compatibility.
#
#  Direct usage (if you already have pwsh):
#    pwsh -File .\Setup-Terminal-Main.ps1              # Interactive menu
#    pwsh -File .\Setup-Terminal-Main.ps1 -yolo        # Install everything
#
